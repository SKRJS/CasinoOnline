          ...
          <div className="row p1">
            <div className="col-md-3">
              <div className="footer-link text-center">
                ...
                <ul>
                  ...
                  <li>
                  <a className="dropdown-item" href="/New_Online_Casinos">
                            New Online Casinos
                          </a>
                  </li>
                  <li>
                  <a className="dropdown-item" href="/FAST_WITHDRAWAL_CASINO">
            ...
            <div className="col-md-3">
              <div className="footer-link text-center">
                ...
                <ul>
                  <li>
                    <a  className="dropdown-item" href="/No_Deposit"> No Deposit Bonus</a>
                  </li>
                  <li>
                  <a className="dropdown-item" href="/FAST_WITHDRAWAL_CASINO">
                          First Deposit Bonus
                  ...
                  <li>
                  <a className="dropdown-item" href='/Bonuses_CASINO'>
                          Casino Bonus
                          </a>
                  </li>
